...
const Stack = createNativeStackNavigator();
  return (
    ...
    <Userstate_Context.Provider value ={[userscreenstate,setuserscreenstate]}>
    <NavigationContainer >

      <Stack.Navigator screenOptions={{ animation: 'none'  ,headerShown:false , gestureEnabled:false}}>
      ...
      <Stack.Group>
        ...
        <Stack.Screen name="emailverifi" component={Emailverificationscreen} />
      ...
      <Stack.Group>
          ...
          <Stack.Screen options={{ animation: 'none' }}    name="Menu" component={Menuscreen} />
          <Stack.Screen options={{ animation: 'none' }}    name="search" component={Searchscreen} />
          <Stack.Screen name="Cart" component={Cartscreen} />
          <Stack.Screen options={{ animation: 'none' }}   name="checkout" component={Checkoutscreen} />
