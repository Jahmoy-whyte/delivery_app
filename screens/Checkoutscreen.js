...
// ================= Guest =====================
         ...
         if (checkoutoption === "delivery"){
          return(
            ...
            <TouchableOpacity  style = {styles.pickup} onPress ={()=> setcheckoutoption("pickup")}>
            <Text style = {styles.pickuptxt}>Pickup</Text>
            </TouchableOpacity>


            <TouchableOpacity  style = {styles.delivery}  onPress ={()=> setcheckoutoption("delivery")}>
       ...
       return(
           ...
           <Text style ={styles.textboxtxt} >{userinfo.fname +" "+ userinfo.lname}</Text>
           </View>
