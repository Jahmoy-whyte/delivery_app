...
const Dishinfoscreen = ({
  ...
  const [txtval, settxtval, buttonenable, addtocart, updatecart] =
    useAddtocart(nav_comment);
  const [quantityandprice, FUNC_Quantitychange] = useQuantitychange(
    nav_quantity,
    nav_dprice
  );
      ...
      <BottomSheetScrollView>
        ...
        <SafeAreaView style={styles.backnav}>
          ...
          <TouchableOpacity onPress={() => FUNC_addtofavorite(nav_dishid)}>
            {loadstatus === true ? null : FUNC_isadded(nav_dishid) === true ? (
        ...
        <ScrollView>
          <View style={styles.bgimg}>
            <Image style={styles.topimg} source={{ uri: nav_dimg }} />
          </View>
          ...
          <View>
            ...
            <View style={styles.quantitycontainer}>
              <TouchableOpacity
                onPress={() =>
                  FUNC_Quantitychange("minus", nav_dprice, nav_quantity)
                }
              >
                <Entypo name="minus" size={24} color="white" />
              </TouchableOpacity>
              <Text style={styles.quantitytxt} allowFontScaling={false}>
                {quantityandprice.quantity}
              </Text>
              <TouchableOpacity
                onPress={() =>
                  FUNC_Quantitychange("plus", nav_dprice, nav_quantity)
                }
              >
      ...
      >
        <View style={styles.leftinfo}>
          ...
          <Text style={styles.txt}>
            $
            {quantityandprice.quantity > 1 &&
            quantityandprice.price == nav_dprice
