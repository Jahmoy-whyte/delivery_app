...
const Signupscreen = ({ navigation }) => {
  ...
  const verifytxt = () => {
    if (isChecked == true) {
      ...
      Alertmessage(
        "Please Read And Agreed To Our Privacy Policy ",
        "custom_error"
      );
    }
  };
          ...
          <View style={styles.fortxtboxhold}>
            ...
            <View style={styles.passwordwrap}>
              <TextInput
                maxLength={100}
                editable={processing == true ? false : true}
                style={styles.textboxforpass}
                onChangeText={(value) => {
                  setboxtxt({ ...boxtxt, password: value });
                }}
                secureTextEntry={!seepassword}
              />
              <TouchableOpacity onPress={() => setseepassword(!seepassword)}>
                <Ionicons
                  name={seepassword === true ? "eye-outline" : "eye-sharp"}
                  size={24}
                  color="#7F7F7F"
                />
              </TouchableOpacity>
            ...
            <View style={styles.wrapper}>
              <Text style={styles.policytxt}>
                ...
                <Text
                  ...
                  onPress={() =>
                    Linking.openURL(
                      "https://johnwtaapptest.000webhostapp.com/privacypolicy.html"
                    )
                  }
                >
                  {" "}
