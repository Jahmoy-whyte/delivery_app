      ...
      const sendorder = await addDoc(collection(db, "Orders"), {
        ...
        Customer_paymentmethod:
          state.setcheckcard === true
            ? "(TEST V1) Paid by card"
            : state.setcheckcash === true
            ? "(TEST V1) Cash"
            : "(TEST V1) Payment Not Known",
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={{ flex: 1, backgroundColor: "white" }}>
          <TouchableOpacity
            ...
            onPress={() => dispatch({ type: "cashselect" })}
          >
            <View style={styles.paymentmethodiconcontainer}>
              ...
              <View style={styles.titleandsubtitlehold}>
                ...
                <Text style={styles.paymentmethodsubtitle}>
                  Pay In Cash On Delivery Or Pick{" "}
                </Text>
              </View>
            </View>
          ...
          <TouchableOpacity
            style={styles.paymentmethod}
            onPress={() => dispatch({ type: "cardselect" })}
          >
            <View style={styles.paymentmethodiconcontainer}>
              <AntDesign
                name="creditcard"
          ...
          {state.setcheckcard == true ? (
            <View>
              ...
              <TouchableOpacity
                ...
                onPress={() => dispatch({ type: "opencardform" })}
              >
        ...
        <Modal
          animationType="slide"
          visible={state.showcardform}
          onRequestClose={() => dispatch({ type: "closecardform" })}
        >
          <ScrollView style={styles.textInputcontainer}>
            <SafeAreaView>
              <View style={styles.header}>
                <TouchableOpacity
                  style={styles.backnavicon}
                  onPress={() => dispatch({ type: "closecardform" })}
                >
                  <Ionicons name="chevron-back" size={20} color="black" />
                </TouchableOpacity>
