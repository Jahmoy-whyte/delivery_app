...
// FUNC_getinfo =====================================================
  ...
  try{
   const qr = query(collection(db, "Dishies"), where("DishType", "==", pass_dishtype),limit(pass_limit));
   ...
   setdishdata(prev=>({...prev,data:arr,loading:false ,lastdata:lastdata1}))
...
// FUNC_restdata=====================================================
 ...
 const FUNC_restdata = useCallback((passedarr)=>{
...
// FUNC_getmoredata=====================================================
 const FUNC_getmoredata = useCallback(async(dishtxt) => {
...
try {
  const qr = query(collection(db, "Dishies"), 
